...
본 문서에서는 웹 콘솔을 이용하여 폴더 생성 및 파일 업로드, 썸네일 옵션을 관리하는 방법에 대해 설명합니다.


## Image 서비스 활성화

- [서비스 선택]에서 [Contents Delivery]의 [Image]를 선택하여 서비스를 활성화 시킵니다.

![[그림 1] Image 서비스 활성화](http://static.toastoven.net/prod_img/v25/img_cg_01.png)
<center>[그림 1] Image 서비스 활성화</center>


## 폴더 및 이미지 파일 관리

- 메뉴의 File View 화면에서 폴더와 원본 이미지 파일, 생성된 썸네일 이미지 파일을 관리할 수 있습니다.

![[그림 2] File View](http://static.toastoven.net/prod_img/v25/img_cg_02.png)
<center>[그림 2] File View</center>

### 툴바 아이콘 설명

![[그림 3] 툴바 아이콘](http://static.toastoven.net/prod_img/v25/img_cg_03.png)
...
![[그림 4] 폴더 생성](http://static.toastoven.net/prod_img/v25/img_cg_04.png)
...
![[그림 5] 업로드](http://static.toastoven.net/prod_img/v25/img_cg_05.png)
...
1.다운로드 할 폴더와 이미지 파일을 선택한 후, [그림 3]의 [다운로드] 버튼을 클릭합니다.
...
![[그림 6] 다운로드](http://static.toastoven.net/prod_img/v25/img_cg_06.png)
<center>[그림 6] 다운로드</center>

### 속성 보기

- 폴더와 이미지 파일을 1개 선택한 후, [그림 3]의 [속성] 버튼을 클릭합니다.
- 폴더 속성 보기에서 하위에 생성된 폴더와 이미지 파일 개수를 확인할 수 있습니다.

### 조회 및 목록 보기

1.[그림 2]에서 보기 필터를 이용하여 이미지 파일의 유형을 필터링하여 볼 수 있습니다.
...
[그림 2]에서 전체 파일 삭제를 할 수 있습니다.

- 상품 이용 종료를 위해서는 전체 파일을 삭제해야 합니다.
- 한번 삭제 된 파일은 다시 복구할 수 없으니 신중하게 사용해야 합니다.
![[그림 7] 전체 파일 삭제](http://static.toastoven.net/prod_img/v25/img_cg_07.png)
<center>[그림 7] 전체 파일 삭제</center>


## 썸네일 옵션 관리

- 메뉴의 Operation Setting 화면에서 썸네일 옵션을 관리할 수 있습니다.
- 여러 가지 옵션을 조합하여 만들 수 있습니다.
- [썸네일 옵션 관리]를 클릭합니다.

![[그림 8] 썸네일 옵션 관리](http://static.toastoven.net/prod_img/v25/img_cg_08.png)
<center>[그림 8] 썸네일 옵션 관리</center>

### 썸네일 생성

- 썸네일 옵션을 추가하기 위해 [추가] 버튼을 클릭합니다.

![[그림 9] 썸네일 옵션 관리 – 썸네일 옵션 추가](http://static.toastoven.net/prod_img/v25/img_cg_09.png)
<center>[그림 9] 썸네일 옵션 관리 – 썸네일 옵션 추가</center>
...
- [그림 9]에 [+추가] 드롭 다운 버튼에서 이미지 오퍼레이션 옵션을 선택하여 이미지 오퍼레이션 시나리오를 추가할 수 있습니다.
- [그림 10]에 썸네일 오퍼레이션 시나리오는 썸네일 크기, 흑백필터, 크롭(Rectangle, Circle, Slice), 워터마크 옵션을 제공합니다.
- 시나리오는 그룹별로 실행되며 동일한 옵션은 중복으로 설정할 수 없습니다.
- 그룹 내에서는 오른쪽 화살표 버튼(▲▼)을 통해 시나리오 순서를 설정 할 수 있습니다.

![[그림 10] 썸네일 옵션 추가 – 이미지 오퍼레이션 추가](http://static.toastoven.net/prod_img/v25/img_cg_10.png)
<center>[그림 10] 썸네일 옵션 추가 – 이미지 오퍼레이션 추가</center>
...
![[그림 11] 썸네일 옵션 관리 – 썸네일 옵션 수정](http://static.toastoven.net/prod_img/v25/img_cg_11.png)
<center>[그림 11] 썸네일 옵션 관리 – 썸네일 옵션 수정</center>

1.[그림 11]에서 썸네일 옵션을 수정 후 저장 버튼을 클릭합니다.

![[그림 12] 썸네일 옵션 수정 – 썸네일 옵션 저장](http://static.toastoven.net/prod_img/v25/img_cg_12.png)
<center>[그림 12] 썸네일 옵션 수정 – 썸네일 옵션 저장</center>
...
썸네일 옵션을 삭제 하기 위해 [그림 8]의 “삭제” 버튼을 클릭합니다.

- 삭제 버튼으로 선택한 썸네일 옵션을 삭제 할 수 있습니다.
- 삭제 전 [그림 13]에 오퍼레이션 이미지 삭제 옵션 체크를 통해 해당 옵션으로 만들어 놓은 썸네일도 삭제 할 수 있습니다.

![[그림 13] 썸네일 옵션 관리 - 썸네일 옵션 삭제](http://static.toastoven.net/prod_img/v25/img_cg_13.png)
<center>[그림 13] 썸네일 옵션 관리 - 썸네일 옵션 삭제</center>

### 사용자 설정

썸네일 옵션 관리 사용자 설정을 위해 [그림 8]에 [설정]버튼을 클릭합니다.

- [그림 14]에서 실시간 처리 활성 여부를 설정합니다.

![[그림 14] 썸네일 옵션 관리 사용자 설정](http://static.toastoven.net/prod_img/v25/img_cg_14.png)
<center>[그림 14] 썸네일 옵션 관리 사용자 설정</center>
