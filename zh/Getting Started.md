...
![[그림 5] 다로드](http://static.toastoven.net/prod_img/img_26.png)
<center>[그림 5] 다로드</center>
...
2.썸네일 옵션을 삭제 하기 위해 [그림 6]의 “삭제” 버튼을 클릭합니다.

![[그림 7] 썸네일 옵션 관리 - 썸네일 옵션 삭제](http://static.toastoven.net/prod_img/img_17_2.png)
<center>[그림 7] 썸네일 옵션 관리 - 썸네일 옵션 삭제</center>

2-1.삭제 버튼으로 선택한 썸네일 옵션을 삭제 할 수 있으며, 삭제 전 [그림 7] 에 오퍼레이션 이미지 삭제 옵션 체크를 통해 해당 옵션으로 만들어 놓은 썸네일도 삭제 할 수 있습니다.

3.썸네일 옵션을 추가 하기 위해 [추가] 버튼을 클릭합니다.

![[그림 8] 썸네일 옵션 관리 – 썸네일 옵션 추가](http://static.toastoven.net/prod_img/img_18_3.png)
<center>[그림 8] 썸네일 옵션 관리 – 썸네일 옵션 추가</center>

3-1.[그림 7]에 옵션의 이름과 설명을 입력합니다. 동일한 옵션 이름이 있을 때는 뒤에 구분자를 덧붙여서 사용하길 권장합니다. 설명은 사용자가 알아보기 쉽게 해당 썸네일 옵션에 대한 간단한 설명을 입력 할 수 있습니다.  

3-2.이미지 처리 옵션을 설정합니다.  
3-2-1.실시간 처리 활성 옵션을 통해 해당 썸네일 옵션에 실시간 처리 여부를 결정할 수 있습니다.  
3-2-2.Gif 애니메이션 효과 유지 여부를 선택할 수 있습니다. 이미지 합성에 해당하는 Circle 크롭과 워터마크는 Gif 애니메이션 효과가 유지되지 않습니다.   
3-2-3.이미지 생성 품질을 설정합니다. 단, 손실 압축 방식 이미지(예: JPEG 등)에 적용 가능합니다. (권장값 80%)  
3-2-4.이미지 생성 포맷을 선택합니다. (기본값은 원본 포맷유지)  
3-2-5."이미지 메타정보 유지"와 "Orientation 정보를 기준으로 이미지 회전" 옵션을 서비스에 맞게 체크/체크해제 합니다.  

3-3.[그림 7]에 [+추가] 드롭 다운 버튼에서 이미지 오퍼레이션 옵션을 선택하여 이미지 프로세싱 시나리오를 설정 할 수 있습니다.  

![[그림 9] 썸네일 옵션 추가 – 이미지 오퍼레이션 추가](http://static.toastoven.net/prod_img/img_19_3.png)
<center>[그림 9] 썸네일 옵션 추가 – 이미지 오퍼레이션 추가</center>

3-4.[그림 9]에 썸네일 오퍼레이션 시나리오는 썸네일 크기, 흑백필터, 크롭(Rectangle, Circle, Slice), 워터마크 옵션을 제공합니다.  
시나리오는 그룹별로 실행되며 동일한 옵션에 중복은 제한합니다. 그룹 내에서는 오른쪽 화살표 버튼(▲▼)을 통해 시나리오 순서를 설정 할 수 있습니다.  
...
3-5-3."확대하지 않음", "축소하지 않음", "확대 축소 가능" 옵션을 서비스에 맞게 체크 합니다.  

3-6.[흑백 필터] 옵션은 해당 순서에 흑백 필터를 이미지에 적용합니다.  

3-7.[크롭] 옵션은 설정된 기준점 좌표와 범위로 이미지를 크롭합니다.  
3-7-1.크롭 방식을 선택합니다. Rectangle, Circle, Slice 크롭 세 가지 방식을 제공합니다.  
...
3-8.[워터마크] 옵션은 이미지 파일을 합성합니다.  
3-8-1.합성 할 기준점을 선택합니다.  
3-8-2.기준점으로부터 이동할 좌표를 선택합니다.  
3-8-3.합성 할 워터마크 이미지 파일을 선택합니다.  

3-9.[저장]버튼을 클릭하면 썸네일 옵션이 추가 됩니다.  

4.썸네일 옵션을 수정 하기 위해 [그림 6]에서 수정할 썸네일 옵션에 체크 후 [수정]버튼을 클릭합니다.  

![[그림 10] 썸네일 옵션 관리 – 썸네일 옵션 수정](http://static.toastoven.net/prod_img/img_20_3.png)
<center>[그림 10] 썸네일 옵션 관리 – 썸네일 옵션 수정</center>

4-1.[그림 10]에서 썸네일 옵션을 수정 후 저장 버튼을 클릭합니다.

![[그림 11] 썸네일 옵션 수정 – 썸네일 옵션 저장.](http://static.toastoven.net/prod_img/img_21_2.png)
<center>[그림 11] 썸네일 옵션 수정 – 썸네일 옵션 저장.</center>

4-2.저장 버튼으로 수정한 썸네일 옵션을 저장 할 수 있으며, 옵션을 수정하더라도 해당 옵션으로 만들어 놓은 썸네일은 수정되지 않습니다. 단, 저장 전 [그림 11]에 오퍼레이션 이미지 삭제 옵션 체크를 통해 해당 옵션으로 만들어 놓은 썸네일을 삭제 할 수 있습니다.  
5.썸네일 옵션 관리 사용자 설정을 위해 [그림 6]에 [설정]버튼을 클릭합니다

![[그림 12] 썸네일 옵션 관리 사용자 설정](http://static.toastoven.net/prod_img/img_22_2.png)
<center>[그림 12] 썸네일 옵션 관리 사용자 설정</center>

5-1.[그림 12]에서 실시간 처리 활성 체크 옵션을 통해 사용자에 이미지 프로세싱 실시간 처리 여부를 설정합니다.  

### 파일 폴더 목록 보기

1.업로드 및 썸네일 된 이미지 파일과 폴더 목록을 볼 수 있습니다.
...
DB에서 like '%검색어%'로 찾는 방식과 유사하게 검색합니다.
대소문자를 구별하여 검색이 됩니다.  
입력 예) sample   
