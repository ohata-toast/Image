...
3.압축(zip)형식으로 다운로드시, Window 7 이하의 기본 압축프로그램에서는 인코딩 문제로 한글파일이 보이지 않습니다. Window 7 이하 OS를 사용하고 계신 경우 Third-party 압축 프로그램을 이용해주시기 바랍니다.
...
![[그림 6] 썸네일 옵션 관리 - 썸네일 옵션 삭제](http://static.toastoven.net/prod_img/img_17_2.png)
...
3-4.[그림8]에 썸네일 오퍼레이션 시나리오는 썸네일 크기, 흑백필터, 크롭(Rectangle, Circle, Slice), 워터마크 옵션을 제공합니다.  
...
![[그림 11] 썸네일 옵션 관리 사용자 설정](http://static.toastoven.net/prod_img/img_22_2.png)
...
![[그림 12] 파일 폴더 목록 보기](http://static.toastoven.net/prod_img/img_24.png)
<center>[그림 12] 파일 폴더 목록 보기</center>


2.[그림12]에서 보기 필터를 이용하여 이미지 파일의 유형을 필터링하여 볼 수 있습니다.
...
4.[그림12]에서 전체 파일 삭제를 할 수 있습니다.
상품 이용 종료를 위해서는 전체 파일을 삭제해야 합니다.
한번 삭제 된 파일은 다시 복구할 수 없으니 신중하게 사용해야 합니다.
![[그림 13] 전체 파일 삭제](http://static.toastoven.net/prod_img/img_25.png)
<center>[그림 13] 전체 파일 삭제</center>
